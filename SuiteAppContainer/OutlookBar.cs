...
namespace OutlookBar
{
	...
	public class IconPanel : ContentPanel
	{
		...
		public void AddIcon(string caption, Image image, EventHandler onClickEvent, string strAppName)
		{
			int index=Controls.Count/2;	// two entries per icon
			PanelIcon panelIcon=new PanelIcon(this, image, index, onClickEvent, /* modified */ strAppName);
	...
	public class PanelIcon : PictureBox
	{
		...
		public PanelIcon(IconPanel parent, Image image, int index, EventHandler onClickEvent, /* modified */ string strAppName)
		{
			// Modified
